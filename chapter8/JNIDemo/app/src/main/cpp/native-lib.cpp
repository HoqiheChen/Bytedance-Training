...
Java_bytedance_com_jnidemo_utils_FaceDetectHelper_nativeInit(JNIEnv *env,
                                                                       jobject instance) {
//    Android_JNI_GetEnv();
...
extern "C"
JNIEXPORT void JNICALL
Java_bytedance_com_jnidemo_utils_FaceDetectHelper_nativeDetectFace(JNIEnv *env,
                                                                             jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_bytedance_com_jnidemo_utils_FaceDetectHelper_nativeSetFaceDetectModelPath(
...
extern "C"
JNIEXPORT void JNICALL
Java_bytedance_com_jnidemo_utils_FaceDetectHelper_nativeSetLicense(JNIEnv *env,
                                                                             jobject instance,
                                                                             jstring license_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_bytedance_com_jnidemo_utils_FaceDetectHelper_nativeUnInit(JNIEnv *env,
                                                                         jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_bytedance_com_jnidemo_utils_FaceDetectHelper_nativeTestWriteBmp(JNIEnv *env,
                                                                               jobject instance) {
