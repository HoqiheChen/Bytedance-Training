...
public class CustomCameraActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rotationDegree = getCameraDisplayOrientation(0);
...
//                getOptimalPreviewSize(width*height,width,height);
                try {
        ...
        findViewById(R.id.btn_record).setOnClickListener(v -> {
            ...
            if (isRecording) {
                ...
                Toast.makeText(CustomCameraActivity.this,info,Toast.LENGTH_LONG).show();
            } else {
                //todo 录制
        ...
        findViewById(R.id.btn_facing).setOnClickListener(v -> {
            ...
            Log.d("tlh", "rotationDegree = " + rotationDegree);
            mCamera.setDisplayOrientation(rotationDegree);
        });
    ...
    private Camera.PictureCallback mPicture = (data, camera) -> {
        ...
        String info = "存储在" + pictureFile.getAbsolutePath();
        Toast.makeText(CustomCameraActivity.this,info,Toast.LENGTH_LONG).show();
        mCamera.startPreview();
    };
